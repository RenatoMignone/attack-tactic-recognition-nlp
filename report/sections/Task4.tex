...
\begin{comment}
This fingerprint is initially characterized by a \emph{Discovery} phase, followed by some \emph{Persistence} actions. Then, there are many \emph{Discovery} commands, some \emph{Execution} actions, and finally \emph{Persistence} steps. Hence, after an exploratory phase, the attacker is probably executing an exploit, finally making its impact persistent.
\end{comment}